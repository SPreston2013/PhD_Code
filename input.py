...
ti = 10. #0.5/m_potential #Phi_initial. [unit = Mpl].. For r<<1, need phi_i to be roughly ~1/m
...
def v_func(t):
    ...
    #return np.float64(0.5 * m_potential**2 * t**n_potential) # unit = Mpl^4 (power law potential) (ti approx 100)
...
def vprime(t):
    ...
    #return np.float64(0.5 * m_potential**2 * n_potential*t**(n_potential-1)) # unit = Mpl^4 (power law potential)
